          ...
          <form action="#" method="post">
            <div className="row">
              <div className="col-md-6 mb-3">
                <input type="text" className="form-control" id="first_name" defaultValue="First Name"/>
              </div>
              <div className="col-md-6 mb-3">
                <input type="text" className="form-control" id="last_name" defaultValue="Last Name"/>
              </div>
        ...
        <div className="cart-summary">
          ...
          <div className="payment-method">
            ...
            <div className="custom-control custom-checkbox mr-sm-2">
              ...
              <label className="custom-control-label" htmlFor="paypal">Paypal <img className="ml-15" src="static/img/core-img/paypal.png" alt /></label>
            </div>
          </div>
